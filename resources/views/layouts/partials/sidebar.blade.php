  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
      <div class="sidenav-header">
          ...
          <a class="navbar-brand m-0" href=" {{ route('admin.dashboard') }} " target="_blank">
              <span class="ms-1 font-weight-bold text-white">SMP Negeri 1 Padang Gelugur</span>
          </a>
      </div>
      <hr class="horizontal light mt-0 mb-2">
      <ul class="navbar-nav">
          <li class="nav-item">
              <a class="nav-link text-white {{ Request::is('admin') ? 'active bg-gradient-primary' : '' }}" href="{{ route('admin.dashboard') }}">
          ...
          <li class="nav-item">
              <a class="nav-link text-white {{ Request::is('admin/profile') ? 'active bg-gradient-primary' : '' }}" href="{{ route('admin.profile.edit') }}">
                  <div class="text-white text-center me-2 d-flex alig9n-items-center justify-content-center">
